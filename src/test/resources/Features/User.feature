...
#    And Verify the updated fields should be reflected in the response
#    And  Also verify the json schema against the response of update user
  ...
  Scenario: Retrieve user detail by passing invalid user id
    ...
    Then Verify the http status code 404 should be displayed when the request is made to fetch details of non existent user
